        ...
        <div className="flex flex-col gap-[18px]">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              {recordsData.map((r, i) => (
                <div key={i} className="flex items-center gap-5 rounded-[13px] border border-line-card bg-white px-5 py-4">
                  ...
                  <div className="flex flex-1 flex-wrap items-center gap-1.5">
                    {r.cats.map((c) => (
                      <span key={c} className="rounded-[6px] bg-neutral px-[9px] py-[3px] text-xs text-secondary">{c}</span>
                    ))}
                  </div>
