...
public final class GradeAndFollowupResultFixture {
    ...
    public static GradeAndFollowupResult withMastery(
        ...
        return new GradeAndFollowupResult(feedback, modelAnswer, score, followupQuestion, mastery, MASTERY_REASON);
    }
    ...
    public static GradeAndFollowupResult withoutMastery(
        ...
        return new GradeAndFollowupResult(feedback, modelAnswer, score, followupQuestion, null, null);
    }
}
